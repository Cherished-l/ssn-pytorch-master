...
if __name__ == "__main__":
    ...
    # parser.add_argument("--root", type=str, help="/home/fangzhengqing/jinxuli/BSDS/BSR")
    # parser.add_argument("--out_dir", default="./log", type=str, help="/home/fangzhengqing/jinxuli/ssn-pytorch-master/output")
    # python train.py --root "/home/fangzhengqing/jinxuli/BSDS/BSR" --train_iter 50000 --nspix 16